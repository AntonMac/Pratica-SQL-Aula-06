...
-- Inserindo em Pessoa
INSERT INTO Pessoa (Nome, Data_Nascimento, Salario) VALUES ("Manoel", "1980-01-01", 2000.00);
INSERT INTO Pessoa (Nome, Data_Nascimento, Salario) VALUES ("Pedro", "1990-01-01", 1500.00);
INSERT INTO Pessoa (Nome, Data_Nascimento, Salario) VALUES ("Manoel", "2000-01-01", 1000.00);
select * from Pessoa p;
-- Inserindo em Produto
INSERT INTO produto  (Nome, Valor) VALUES ("Bola_Basquete", 199.99);
INSERT INTO produto  (Nome, Valor) VALUES ("Camiseta", 59.99);
INSERT INTO produto  (Nome, Valor) VALUES ("Refrigerador", 1999.00);
INSERT INTO produto  (Nome, Valor) VALUES ("EhPhone", 9.99);
select  * from produto p;

-- Inserindo em Categoria_Produto
INSERT INTO categoria_produto (Nome) VALUES ("Esportivo");
INSERT INTO categoria_produto (Nome) VALUES ("Moda");
...
VALUES ("Sport_Shop", "Tal da lee", "Esse Bairro", "Recife", "111", "55555-555", "Aqui_Comp");
INSERT INTO loja (Nome, Rua, Bairro, Cidade, Numero, CEP, Complemento) 
VALUES ("Moda_Shop", "Tal da Akii", "Nesse Bairro", "Olinda", "222", "56666-666", "mais_Comp");
INSERT INTO loja (Nome, Rua, Bairro, Cidade, Numero, CEP, Complemento) 
VALUES ("Domestic_Shop", "Av alibaba", "Outro Bairro", "Camaragibe", "333", "57777-777", "comp_Comp");
INSERT INTO loja (Nome, Rua, Bairro, Cidade, Numero, CEP, Complemento) 
VALUES ("Tronicos_Shop", "Rua deles", "Sem Bairro", "Quipapa", "444", "58888-888", "eita_Comp");
select  * from Loja l;

-- Inserindo em Funcao

INSERT INTO funcao (Nome, Descricao) VALUES ("Contador", "Responsavel pela Contabilidade");
INSERT INTO funcao (Nome, Descricao) VALUES ("Vendedor", "Responsavel por Vendas");
INSERT INTO funcao (Nome, Descricao) VALUES ("Estoquista", "Mantenimento do estoque");
INSERT INTO funcao (Nome, Descricao) VALUES ("Gerente", "Mandar nos outros");
select  * from funcao l;

-- Inserindo em Formação

INSERT INTO formacao  (Grau, Curso, Instituicao) VALUES ("Superior", "Contabilidade", "CesarSchool" );
INSERT INTO formacao  (Grau, Curso, Instituicao) VALUES ("Tecnologo", "Logistica", "CesarSchool" );
INSERT INTO formacao  (Grau, Curso, Instituicao) VALUES ("Superior", "Administração", "CesarSchool" );
INSERT INTO formacao  (Grau, Curso, Instituicao) VALUES ("Tecnologo", "Marketing", "CesarSchool" );
select * from formacao ff;

-- Inserindo em departamento
INSERT INTO departamento  (Nome, Descricao) VALUES ("Vendas", "Gerenciar e Realizar vendas" );
INSERT INTO departamento  (Nome, Descricao) VALUES ("Logistica", "Estoque e distribuição" );
INSERT INTO departamento  (Nome, Descricao) VALUES ("Financeiro", "Pessoal que lida com money" );
INSERT INTO departamento  (Nome, Descricao) VALUES ("Administrativo", "Os mandões" );
